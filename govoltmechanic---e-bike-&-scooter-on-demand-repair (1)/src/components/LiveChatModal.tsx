  ...
  const handleSend = (textToSend?: string) => {
    ...
    setTimeout(() => {
      const autoReplies = [
        ...
        "Understood. Approaching your area now, driving safely on Market St.",
        ...
        <div className="px-6 py-4 bg-white/5 border-b border-white/10 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="p-2 bg-white/5 hover:bg-white/10 rounded-xl text-green-400 transition-colors"
            >
