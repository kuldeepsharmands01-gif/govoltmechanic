  ...
  return (
    <nav className="px-4 sm:px-8 py-4 sm:py-5 flex flex-wrap items-center justify-between border-b border-white/10 bg-[#0A0B10]/90 backdrop-blur-xl sticky top-0 z-40">
      ...
      <div className="flex items-center gap-2.5 sm:gap-3.5 mt-2 sm:mt-0">
        {/* Static Specialist Hotline Direct Call */}
        <a
        ...
        >
          ...
          <span className="hidden xl:inline text-[11px] font-mono tracking-tight text-slate-200 group-hover:text-cyan-300">{specialistPhone}</span>
          <span className="xl:hidden text-[11px] uppercase tracking-wider font-extrabold text-cyan-400">HOTLINE</span>
        </a>
        ...
        <div className="flex items-center gap-2.5 pl-2 border-l border-white/10">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-xs font-bold text-slate-200">Pradeep</p>
          </div>
