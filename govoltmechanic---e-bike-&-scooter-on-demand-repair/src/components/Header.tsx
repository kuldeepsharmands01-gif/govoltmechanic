  ...
  return (
    <nav className="px-4 sm:px-8 py-4 sm:py-5 flex flex-wrap items-center justify-between border-b border-white/10 bg-[#0A0B10]/90 backdrop-blur-xl sticky top-0 z-40">
      ...
      <div className="flex items-center gap-3 cursor-pointer" onClick={() => setActiveTab('dashboard')}>
        <div className="w-8 h-8 bg-cyan-400 rounded-sm rotate-45 flex items-center justify-center shadow-[0_0_12px_#22d3ee]">
          <div className="w-4 h-4 bg-[#0A0B10] rounded-sm"></div>
        </div>
        <div className="flex flex-col">
          <span className="text-2xl font-black tracking-tighter italic text-white flex items-center gap-1.5">
            GOVOLT
            <span className="text-[10px] uppercase not-italic tracking-widest px-1.5 py-0.5 rounded bg-cyan-500/20 text-cyan-400 border border-cyan-500/30">
              EV REPAIR
            </span>
          </span>
        </div>
