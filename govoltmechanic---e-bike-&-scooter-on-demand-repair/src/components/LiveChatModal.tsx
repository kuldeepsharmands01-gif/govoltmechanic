  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'm1',
      sender: 'tech',
      text: `Hi Pradeep! I'm en route in ${technician.vanId} with your hydraulic brake bleed kit and BMS diagnostic scanner. ETA is around 8 minutes.`,
      timestamp: '10:14 AM',
    },
    {
      id: 'm2',
      sender: 'user',
      text: `Awesome, thanks ${technician.name.split(' ')[0]}! Can you also take a quick look at my rear wheel spoke tension and brake pad wear?`,
      timestamp: '10:15 AM',
    },
    {
      id: 'm3',
      sender: 'tech',
      text: 'Absolutely! I carry digital micrometers and genuine OEM spares in the mobile van. All doorstep repairs are completed right in front of you with full 10-day warranty.',
      timestamp: '10:16 AM',
    },
  ]);
