                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right shrink-0">
                        <p className="font-mono font-bold text-base text-cyan-400">₹{service.price.toLocaleString('en-IN')}</p>
            ...
            <div className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    {selectedServices.map((s) => (
                      <div key={s.id} className="flex justify-between text-xs">
                        ...
                        <span className="font-mono text-cyan-400 font-bold">₹{s.price.toLocaleString('en-IN')}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="font-bold text-white text-[11px]">10-Day / 1000 KM Service Warranty</p>
                    <p className="text-[10px] text-slate-400">100% Genuine OEM Parts • Doorstep Repairs Done in Front of You</p>
                  </div>
                </div>
                <span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300 text-[9px] font-black uppercase tracking-wider border border-emerald-500/30">
                  APNA PROMISE
                </span>
              </div>
              ...
              <div className="space-y-2.5">
                <label className="text-xs font-bold uppercase tracking-widest text-cyan-400 block">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <Smartphone className={`w-4 h-4 ${paymentMethod === 'upi' ? 'text-cyan-400' : 'text-slate-400'}`} />
                      {paymentMethod === 'upi' && <span className="w-2 h-2 rounded-full bg-cyan-400"></span>}
                    </div>
                    <span className="text-xs font-black text-white">UPI Pay</span>
                    <span className="text-[9px] text-slate-400 font-mono">GPay/PhonePe/QR</span>
                  </button>
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <CreditCard className={`w-4 h-4 ${paymentMethod === 'credit_card' ? 'text-cyan-400' : 'text-slate-400'}`} />
                      {paymentMethod === 'credit_card' && <span className="w-2 h-2 rounded-full bg-cyan-400"></span>}
                    </div>
                    <span className="text-xs font-black text-white">Credit Card</span>
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <Building2 className={`w-4 h-4 ${paymentMethod === 'debit_card' ? 'text-cyan-400' : 'text-slate-400'}`} />
                      {paymentMethod === 'debit_card' && <span className="w-2 h-2 rounded-full bg-cyan-400"></span>}
                    </div>
                    <span className="text-xs font-black text-white">Debit Card</span>
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      <Banknote className={`w-4 h-4 ${paymentMethod === 'cod' ? 'text-cyan-400' : 'text-slate-400'}`} />
                      {paymentMethod === 'cod' && <span className="w-2 h-2 rounded-full bg-cyan-400"></span>}
                    </div>
                    <span className="text-xs font-black text-white">Pay on Service</span>
                    <span className="text-[9px] text-slate-400 font-mono">Cash or UPI on-site</span>
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-4 space-y-2 text-xs">
                ...
                <div className="flex justify-between text-slate-400">
                  ...
                  <span className="font-mono text-green-400 font-bold">FREE PROMO (₹0)</span>
                </div>
                <div className="flex justify-between text-slate-400">
                ...
                <div className="pt-2 border-t border-white/10 flex justify-between items-center text-sm font-bold">
                  <span className="text-white">Total Charge (Inclusive of All Taxes)</span>
                  <span className="text-xl font-mono text-cyan-400">₹{totalPrice.toLocaleString('en-IN')}</span>
                </div>
              </div>
            </div>
          )}
