  ...
  return (
    <div className="bg-[#0D0E15] border border-white/10 rounded-2xl p-5 sm:p-6 space-y-6 shadow-xl">
      ...
      <div className="grid grid-cols-2 gap-3 pt-2">
        <button
          onClick={onOpenChat}
          className="py-3 px-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-xs font-bold uppercase tracking-wider text-white transition-colors flex items-center justify-center gap-2 active:scale-95"
        >
        ...
        <div className="relative group/call">
          <a
            ...
            className="w-full py-3 px-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-xs font-bold uppercase tracking-wider text-white transition-colors flex items-center justify-center gap-1.5 active:scale-95"
          >
          ...
          {onEditPhone && (
            <button
              ...
              className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-cyan-500 text-black flex items-center justify-center shadow-[0_0_8px_#22d3ee] hover:scale-110 transition-transform"
            >
      ...
      <p className="text-[10px] text-center font-mono text-slate-500">
        Hotline: <span className="text-cyan-400 font-bold">{targetPhone}</span>
      </p>
