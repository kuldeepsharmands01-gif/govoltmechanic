...
export default function App() {
  ...
  const handleLogin = (user: UserProfile) => {
    ...
    if (user.role === 'technician') {
      ...
      // Stay on the current page if already on any customer tab (e.g. Services, AIGen, About, Garage, Diagnostics, Help)
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col justify-between selection:bg-red-500 selection:text-white">
      ...
      <main className="flex-1 p-4 sm:p-6 md:p-8 max-w-[1600px] w-full mx-auto space-y-6">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
              ...
              <div className="lg:col-span-5 xl:col-span-4 flex flex-col gap-6">
                ...
                <div className="bg-red-50 border border-red-200 rounded-3xl p-5 relative overflow-hidden shadow-sm">
                  <div className="flex items-center justify-between gap-3 mb-3">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-xl bg-red-100 border border-red-300 flex items-center justify-center text-red-600 animate-pulse">
                      ...
                      <div>
                        ...
                        <h4 className="text-sm font-black text-black">Emergency Priority Dispatch</h4>
                      </div>
                    </div>
                    <span className="px-2 py-0.5 bg-red-100 text-red-700 text-[9px] font-mono font-bold rounded-full border border-red-200">
                      ~4 MIN RESCUE
                    </span>
                  </div>
                  <p className="text-xs text-slate-700 mb-3.5">
                    Instant priority request to the nearest mobile technician for critical battery, brake, or motor failures.
                  </p>
                  <button
                    onClick={() => setIsSOSOpen(true)}
                    className="w-full py-3 bg-red-600 hover:bg-red-700 text-white font-black text-xs uppercase tracking-widest rounded-xl transition-all shadow-md active:scale-95 flex items-center justify-center gap-2"
                  >
        ...
        {/* AIGEN VIEW (Veo 3.1 Fast Image-to-Video) */}
        {activeTab === 'aigen' && (
          <AIGenTab
            onOpenBooking={() => setIsBookingOpen(true)}
          />
