      ...
      <main className="flex-1 p-4 sm:p-6 md:p-8 max-w-[1600px] w-full mx-auto space-y-6">
        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-8">
            {/* Top Hero Banner in Black & Reddish Theme */}
            <HomeHeroBanner
              onOpenBooking={() => setIsBookingOpen(true)}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
              ...
              <div className="lg:col-span-5 xl:col-span-4 flex flex-col gap-6">
                ...
                <div className="p-3.5 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 border border-white/10 rounded-2xl flex items-center justify-between gap-3 shadow-md">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-bold text-white">
                        Signed in as <strong className="text-cyan-400 font-mono uppercase">{currentUser.role}</strong> ({currentUser.name})
                      </p>
                    </div>
                  </div>
                  <button
