...
export default function App() {
  ...
  // Specialist Phone Number State
  const [specialistPhone, setSpecialistPhone] = useState<string>(() => {
    return localStorage.getItem('govolt_specialist_phone') || '+91 98391 88200';
  });
  ...
  const handleSaveSpecialistPhone = (newPhone: string) => {
    setSpecialistPhone(newPhone);
    localStorage.setItem('govolt_specialist_phone', newPhone);
  };
  ...
  return (
    <div className="min-h-screen bg-[#0A0B10] text-slate-100 font-sans flex flex-col justify-between selection:bg-cyan-500 selection:text-black">
      ...
      <SpecialistPhoneModal
        ...
        currentPhone={specialistPhone}
        onSavePhone={handleSaveSpecialistPhone}
      />
